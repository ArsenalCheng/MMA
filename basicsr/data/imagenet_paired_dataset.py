...
class ImageNetPairedDataset(data.Dataset):
    ...
    def __init__(self, opt):
        ...
        if self.io_backend_opt['type'] == 'lmdb':
            ...
            self.paths = []
            class_list = os.listdir(self.gt_folder)
            for item in class_list:
                current_dir = self.gt_folder + '/' + item
                current_paths = os.listdir(current_dir)
                current_paths = [current_dir + '/' + i for i in current_paths]
